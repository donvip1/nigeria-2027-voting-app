...
- Provide a protected starter CMS for candidate content updates.
...
- CMS: Supabase Auth email OTP, `cms_admins` allow-list, RLS-protected candidate updates.
...
9. Add protected starter CMS for candidate edits. Done.
...
- Test the CMS login and candidate save flow after `cms_admin_setup.sql` is run.
- Add poll editing to the CMS.
...
- Full admin dashboard for editing polls, ads settings, and homepage content.
